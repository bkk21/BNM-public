...
public class Movenet_First_Test extends AppCompatActivity implements SurfaceHolder.Callback, TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movenet_first_test);
...
public void onClick(View view) {
        ...
        Intent intent = new Intent(Movenet_First_Test.this, Home.class);
