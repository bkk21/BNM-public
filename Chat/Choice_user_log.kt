...
class Choice_user_log : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choice_user_log)
        get_user_id()
    ...
    private fun setButtonEvents(){
        ...
        for (i in 0 until btn_num) {
            ...
            btn?.setOnClickListener{
                ...
                val Chat_log_go = Intent(this, com.khci.bnm.Chat.Chat_log::class.java)
                val sharedPreference = getSharedPreferences("chat_log", Context.MODE_PRIVATE)
